...
<div class ="row">
	<div class ="col-md-6">
		Zauber aktiviert (eigene und fremde Representation): {{range .Held.ZauberCount}} {{.}} {{end}}
	</div>
	<div class ="col-md-6">
		Maximale Aktivierungen: (eigene und fremde Representation): {{range .Held.ZauberCountMax}} {{.}} {{end}}
	</div>
</div>
</div>
<div class ="row">
	...
	<div class ="col-md-6">
		<form>
			<div class="form-group">
				...
				<select class="form-control" name="SFToAddMagisch" id="SFToAddMagisch">
